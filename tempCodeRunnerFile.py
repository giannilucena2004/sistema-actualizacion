...
# --- Configuración visual: Paleta de colores y fuentes ---
...
def abrir_ventana_actualizacion():
    """Abre la ventana para actualizar registros, con mejoras visuales."""
...
def mostrar_acerca_de():
    """Muestra la ventana de "Acerca de", con mejoras visuales."""
...
tk.Label(
    main_frame,
    text="Bienvenido al sistema de actualización de datos.\n"
        "Haz clic en el botón para importar nuevos registros desde una fecha específica.",
    bg=COLOR_BACKGROUND,
    fg=COLOR_TEXT,
    font=FONT_NORMAL,
    justify="center"
